...
mod tests {
    ...
    fn test_slot_to_container_name() {
        assert_eq!(ContainerManager::slot_to_container_name(0), "r0");
        assert_eq!(ContainerManager::slot_to_container_name(5), "r5");
        assert_eq!(ContainerManager::slot_to_container_name(42), "r42");
    }
}
